...
app.use(
  cors({
    origin: process.env.CLIENT_URL, // Use the specific frontend URL from the environment variable
    credentials: true,             // IMPORTANT: Allows the browser to send cookies/auth headers
